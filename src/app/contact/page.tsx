...
export default function Page() {
  return <article className="legal"><p className="eyebrow">Legal / support</p><h1>Contact</h1><p>For corrections, source updates, or rights-holder requests, contact hello@anime-squadron.net. Do not send account passwords, Roblox credentials, or private tokens.</p><p>{site.name} is not affiliated with Roblox, Komplex Studio, Anime Squadron developers, or anime/game rights holders.</p><p>Last updated: {site.checkedAt}</p></article>;
}
